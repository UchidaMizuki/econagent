...
- `util_2goods_utility()` returns the function of total utility or marginal utility
...
```{r plot-marginal-utility, echo=FALSE, fig.width=7, fig.height=3, warning=FALSE}
library(patchwork)
